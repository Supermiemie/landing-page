...
import * as sty from "./PlasmicAvatar.module.css"; // plasmic-import: Ut5uH_6qSzxyIT/css
    ...
    >
      {p.renderPlasmicSlot({
        defaultContents: (
          <img
            alt={""}
            className={classNames(defaultcss.img, sty.img__eFqT6)}
            role={"img"}
