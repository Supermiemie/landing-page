...
import * as sty from "./PlasmicTopSection.module.css"; // plasmic-import: OJ31-UuJf2WO1/css

import heroImageOi4J6GTPyKox7 from "./images/heroImage.png"; // plasmic-import: OI4-j6gTPyKox7/picture
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.box___67OH5)}
      >
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.box__i4FyE)}
        >
          <div className={classNames(defaultcss.all, sty.box__i6Fbc)}>
            <div
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.box__i6QCm)}
        >
          <LinkButton
            className={classNames("__wab_instance", sty.linkButton__l0W4)}
            text={"Start free trial"}
            type={"solidBlue" as const}
          />

          <LinkButton
            className={classNames("__wab_instance", sty.linkButton__m2Vp3)}
            text={"Learn more"}
            type={"solidBlack" as const}
          />
        </p.Stack>

        <div className={classNames(defaultcss.all, sty.box__l2Vy)}>
          <img
