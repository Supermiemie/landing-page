...
import Plan from "../../Plan"; // plasmic-import: brKcf_kd099KVk/component
...
import Faq from "../../Faq"; // plasmic-import: w9htX4EhrOx5sW/component
...
import * as sty from "./PlasmicPricing.module.css"; // plasmic-import: j1d4MVWC4B_tRD/css
      ...
      <div className={defaultcss.plasmic_page_wrapper}>
        ...
        >
          <p.Stack
            as={"div"}
            hasGap={true}
            className={classNames(defaultcss.all, sty.box__jGnvX)}
          >
            <Header
            ...
            <Section
              className={classNames("__wab_instance", sty.section__ei0Uh)}
              subtitle={
            ...
            <p.Stack
              as={"div"}
              hasGap={true}
              className={classNames(defaultcss.all, sty.box__saF9R)}
            >
              <Plan
                className={classNames("__wab_instance", sty.plan___4760T)}
                price={
                  <div
                    className={classNames(
                      defaultcss.all,
              ...
              <Plan
                className={classNames("__wab_instance", sty.plan___6Q5G)}
                description={
                  <p.Stack
                    as={"div"}
                    hasGap={true}
                    className={classNames(defaultcss.all, sty.box__ssw74)}
                  >
                    <Bullet
                      className={classNames(
                        "__wab_instance",
                    ...
                    <Bullet
                      className={classNames("__wab_instance", sty.bullet__hWbW)}
                    />
                  </p.Stack>
                }
                name={"Team"}
              ...
              <Plan
                className={classNames("__wab_instance", sty.plan__inOhv)}
                name={"Enterprise"}
                price={
                  <div
                    className={classNames(
            ...
            <Section
              className={classNames("__wab_instance", sty.section__cg0Cm)}
              subtitle={
                <React.Fragment>
                  <div
                    className={classNames(
                  ...
                  <Faq
                    className={classNames("__wab_instance", sty.faq__wBkvu)}
                    slot={
                  ...
                  <Faq
                    className={classNames("__wab_instance", sty.faq___2KHvg)}
                    slot={
                      "Yes! You can. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur excepteur sint occaecat cupidatat."
                    }
                  >
                  ...
                  <Faq
                    className={classNames("__wab_instance", sty.faq__eaHdK)}
                    slot={
                      "Yes! You can. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur excepteur sint occaecat cupidatat."
                    }
                  >
