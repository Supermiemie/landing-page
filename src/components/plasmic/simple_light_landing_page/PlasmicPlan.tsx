...
import BaseCard from "../../BaseCard"; // plasmic-import: L7Plj53-r9vDBP/component
...
import * as sty from "./PlasmicPlan.module.css"; // plasmic-import: brKcf_kd099KVk/css
...
function PlasmicPlan__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(defaultcss.all, sty.box__dfv3C)}>
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.box___5V2Ng)}
        >
          {p.renderPlasmicSlot({
          ...
          {p.renderPlasmicSlot({
            defaultContents: (
              <p.Stack
                as={"div"}
                hasGap={true}
                className={classNames(defaultcss.all, sty.box__zHzOy)}
              >
                <Bullet
                  className={classNames("__wab_instance", sty.bullet__fJbcl)}
                />

                <Bullet
                  className={classNames("__wab_instance", sty.bullet__vKDwj)}
                />

                <Bullet
                  className={classNames("__wab_instance", sty.bullet__u7Wzr)}
                />
              </p.Stack>
            ),
          ...
          <div className={classNames(defaultcss.all, sty.box__cDtmj)}>
            {p.renderPlasmicSlot({
              defaultContents: (
                <LinkButton
                  text={"Get started"}
