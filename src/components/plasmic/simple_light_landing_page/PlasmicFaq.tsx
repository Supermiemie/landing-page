...
import * as sty from "./PlasmicFaq.module.css"; // plasmic-import: w9htX4EhrOx5sW/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.box__dnEw9)}
      >
        <div className={classNames(defaultcss.all, sty.box__hjllD)}>
          <div className={classNames(defaultcss.all, sty.box__uZc)}>
            {p.renderPlasmicSlot({
