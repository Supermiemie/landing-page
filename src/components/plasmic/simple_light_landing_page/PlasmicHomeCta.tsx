...
import * as sty from "./PlasmicHomeCta.module.css"; // plasmic-import: 84ghH0mxt-Li2/css

import SphereIcon from "./icons/PlasmicIcon__Sphere"; // plasmic-import: 8g8AxJjZiIHmmB/icon
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.box__tkJtO)}
      >
        <div
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.box__ylaPz)}
        >
          <input
      ...
      {(hasVariant(globalVariants, "screen", "mobile") ? false : true) ? (
        <div className={classNames(defaultcss.all, sty.box___7Dz3X)}>
          <SphereIcon
